...
var tUtils=tUtils||{},Alfalab=Alfalab||{data:{}};
(function(d){tUtils.baseErrorPane="#block-system-main";Drupal.ajax.prototype.commands.hide_messages=function(a,b,c){d("#testlab_ajax_error, #inline-messages").remove()};Drupal.ajax.prototype.commands.error=function(a,b,c){a=""!==b.selector?b.selector:Drupal.settings.hasOwnProperty("baseErrorPane")?Drupal.settings.baseErrorPane:tUtils.baseErrorPane;(b.hasOwnProperty("hidePrevious")?b.hidePrevious:1)&&d("#testlab_ajax_error, #inline-messages").remove();c=b.hasOwnProperty("severity")?b.severity:"error";
if(b.hasOwnProperty("message"))d(a).prepend("<div id='testlab_ajax_error' class='messages "+c+"'>"+b.message+"</div>");else if(b.hasOwnProperty("messages")){d(a).prepend("<div id='testlab_ajax_error' class='messages "+c+"'><ul></ul></div>");for(var e in b.messages)d("#testlab_ajax_error."+c+" ul").append("<li>"+b.messages[e]+"</li>")}Drupal.unblockUI()};Drupal.ajax.prototype.commands.unblock_ui=function(a,b){Drupal.unblockUI()};Drupal.ajax.prototype.commands.redirect=function(a,b){b.hasOwnProperty("url")?
window.location=b.url:window.location.reload();Drupal.unblockUI()};Drupal.ajax.prototype.commands.fancyPdf=function(a,b){b.hasOwnProperty("url")&&tUtils.fancyPdf(b.url);Drupal.unblockUI()};Drupal.ajax.prototype.commands.ajaxDrupalMessages=function(a,b,c){tUtils.ajaxDrupalMessages(b.messagePlacement,b.messages)};Drupal.ajax.prototype.commands.close_dialog=function(a,b){d("[id*=dialog-pane]").remove();Drupal.unblockUI()};tUtils.isIE=function(a,b){var c="IE",e=document.createElement("B"),d=document.documentElement;
a&&(c+=" "+a,b&&(c=b+" "+c));e.innerHTML="\x3c!--[if "+c+']><b id="iecctest"></b><![endif]--\x3e';d.appendChild(e);a=!!document.getElementById("iecctest");d.removeChild(e);return a};tUtils.pad=function(a,b){for(a=""+a;a.length<b;)a="0"+a;return a};tUtils.arrayUnique=function(a){a=a.concat();for(var b=0;b<a.length;++b)for(var c=b+1;c<a.length;++c)a[b]===a[c]&&a.splice(c--,1);return a};tUtils.numberWithThousandSeparators=function(a,b){return a.toString().replace(/\B(?=(\d{3})+(?!\d))/g,b)};tUtils.labelDeclension=
function(a,b){var c=[2,0,1,1,1,2];return b[4<a%100&&20>a%100?2:c[5>a%10?a%10:5]]};tUtils.blockingAjax=function(a,b,c,e){var d="undefined"!==typeof e&&e.hasOwnProperty("timeout")?e.timeout:3E5,f="undefined"!==typeof e&&e.hasOwnProperty("message")?e.message:void 0;tUtils.showBlockUIMessage(d,f);tUtils.ajax(a,b,c,!1,e)};tUtils.ajax=function(a,b,c,e,d){"undefined"!==typeof b&&""!==b&&!1!==b&&(tUtils.baseErrorPane="#"+b);a={url:a,progress:{type:e?"throbber":"none"}};"undefined"!==typeof d&&d.hasOwnProperty("data")&&
(a.submit=d.data);(new Drupal.ajax(b,c,a)).eventResponse(!1,{})};tUtils.showBlockUIMessage=function(a,b,c){"undefined"===typeof b&&(b="\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430...");"undefined"===typeof c&&(c="");d.blockUI({message:"<h1 class='loading-blocker'><span>"+b+"</span></h1>"+c,css:{width:"auto",left:"45%",border:"1px solid #aaa"},overlayCSS:{backgroundColor:"#fff",opacity:.1}});tUtils.setTimeout(Drupal.unblockUI,a,"unblockui")};tUtils.chosenDefaultOptions={placeholder_text:"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f",
...
(clearTimeout(tUtils.activeTimeouts.unblockui),tUtils.activeTimeouts.unblockui=null);d.unblockUI()};Drupal.blockUI=function(a){tUtils.showBlockUIMessage(3E5,a)};tUtils.confirmationDialog=function(a,b,c,e){var g=d('<div id="dialog-pane">');g.dialog({modal:!0,draggable:!1,resizable:!1,width:400,minHeight:0,title:a,dialogClass:"confirmation-dialog",buttons:[{text:b,click:function(){d(this).dialog("close");g.remove();e()}},{text:c,click:function(){d(this).dialog("close");g.remove()}}]})};tUtils.fancyPdf=
function(a,b){d.fancybox({href:a,autoSize:!0,fitToView:!0,margin:10,height:window.innerHeight-20,type:"iframe",iframe:{preload:!1},afterClose:function(){void 0!==b&&b()}})};Drupal.ajax.prototype.commands.progress_iterate=function(a,b){Drupal.settings.progressDialogProgressCallback(+b.iteration+1)};tUtils.showProgressDialog=function(a,b,c,e,g){var f=null,k={createProgressBar:function(){f=d(".progress-blocker");f.prepend('<div class="progress-title">'+a+"</div>");f.append('<div class="progress-label">0%</div>');
f.progressbar({change:function(b,a){d(".progress-label").text(f.progressbar("value")+"%")},complete:function(b,a){Drupal.unblockUI()},create:function(b,a){k.progressCallback(0)}})},progressCallback:function(a){f.progressbar("option","value",Math.round(100*a/e));a===e?c():b(a)}};Drupal.settings.progressDialogProgressCallback=k.progressCallback;d.blockUI({message:"<div class='progress-blocker'></div>",css:{width:"300px",left:"45%",border:"2px solid #aaa",backgroundColor:"#fff"},overlayCSS:{backgroundColor:"#fff",
opacity:.1},onBlock:k.createProgressBar});tUtils.setTimeout(Drupal.unblockUI,g,"unblockui")};tUtils.ajaxDrupalMessages=function(a,b){d("#inline-messages.messages").remove();for(var c=["error","warning","status"],e=0;e<c.length;e++){var g=c[e];if(b.hasOwnProperty(g))for(var f=b[g],k=0;k<f.length;k++){var l=f[k],h=d('<div id="inline-messages">');h.html(l);h.addClass("messages");h.addClass(g);d(a).prepend(h)}}};tUtils.bindOnce=function(a,b,c,e){a.each(function(){var a=d(this);a.hasClass(e+"-processed")||
(a.bind(b,c),a.addClass(e+"-processed"))})};tUtils.loadScript=function(a,b){var c=document.getElementsByTagName("head")[0],e=document.createElement("script");e.type="text/javascript";e.src=a;e.onreadystatechange=b;e.onload=b;c.appendChild(e)};tUtils.chosenReadonlyBeforeUpdated=function(a){a.attr("readonly")&&(a.prop("disabled",!0),setTimeout(function(){a.prop("disabled",!1)},300))};tUtils.togglePasswordVisibility=function(){d(".cabinet-login-form .form-type-password").each(function(){var a=d(this),
b=d("<span class='toggle-password eye-close'>");a.append(b)});d(".toggle-password").click(function(a){a=d(a.target);a.toggleClass("eye-close");a.toggleClass("eye-open");a=a.siblings("#edit-password");var b="password"===a.prop("type")?"text":"password";a.prop("type",b)})};Drupal.behaviors.togglePasswordVisibility={attach:function(){tUtils.togglePasswordVisibility()}};Drupal.behaviors.dateAutoSelectOnPrevNext={attach:function(a){d("input[autoSelectOnPrevNext]:not(.autoselect-prevnext-processed)",a).datepickerDateAutoSelectOnPrevNext()}};
d.fn.datepickerDateAutoSelectOnPrevNext=function(){var a=d(this);0!==a.length&&(d.datepicker?(a.click(function(){var a=d(this);a.datepicker("option","onChangeMonthYear",function(b,e){a.attr("monthChanged",!0);b="01."+tUtils.pad(e,2)+"."+b;a.val(b)});a.datepicker("option","beforeShowDay",function(b){b=b.getDate();var c=[1,"ui-datepicker-current-day ui-state-default ui-state-active-a"];if("true"==a.attr("monthChanged")){if(1==b)return c}else{var d=a.datepicker("getDate");if(null!=d&&b==d)return c}return[1,
""]});a.datepicker("option","onClose",function(b){a.attr("monthChanged","false")})}),a.addClass("autoselect-prevnext-processed")):console.warn("'datepicker' plugin is not loaded"))};Drupal.behaviors.submitOnce={attach:function(a){d("form:not(.submit-once-processed)",a).disableOnSubmit(["[submit-once]"])}};d.fn.disableOnSubmit=function(a){var b=this;b.submit(function(){if(Drupal.hasOwnProperty("myClientsideValidation")&&0===Drupal.myClientsideValidation.validators[b.attr("id")].errorList.length)for(var c in a)d(a[c]).attr("disabled",
"disabled")});b.addClass("submit-once-processed")};d.fn.selectOptionsSort=function(){var a=this.val(),b=this.children("option");b.sort(function(a,b){return a.text>b.text?1:a.text<b.text?-1:0});this.empty().append(b);this.val(a)};d.fn.setEnterPressHandler=function(a){this.bind("keypress",function(b){13===(b.keyCode?b.keyCode:b.which?b.which:b.charCode)&&(void 0!==a&&a(),b.preventDefault())})};d.fn.linkSubmitButtonToTextfield=function(a){var b={setBtnState:function(a,b){b?(a.removeAttr("disabled"),
a.removeAttr("title")):(a.attr("disabled","disabled"),a.attr("title",'\u0417\u0430\u043f\u043e\u043b\u043d\u0438\u0442\u0435 \u043f\u043e\u043b\u0435 "\u0424\u0418\u041e"'))},btnHasFilters:function(a){return a.is("[filters]")&&"false"!==a.attr("filters")},textfieldHasValue:function(a){var b=!1;return d(a).each(function(a,c){b|=""!==d(c).val()})}},c=this;d(a).keyup(function(){b.btnHasFilters(c)||b.setBtnState(c,b.textfieldHasValue(a))}).bind("paste",function(a){b.setBtnState(c,""!==a.originalEvent.clipboardData.getData("text"))}).bind("cut",
function(){setTimeout(function(){b.setBtnState(c,b.textfieldHasValue(a))},0)}).setEnterPressHandler(function(){var b=d(a);b.is("[autocomplete]")&&b.nameAutocomplete("selectFirstDropdownItem");c.mousedown()});b.setBtnState(c,b.btnHasFilters(c)||b.textfieldHasValue(a))};Drupal.ajax.prototype.commands.autocomplete_data_received=function(a,b){a=Drupal.settings.nameAutocomplete[b.id];var c=[];a.data=a.responseDataProcessor(b.data,c);a.response(c)};Drupal.settings.nameAutocomplete={};d.fn.nameAutocomplete=
function(a){var b={init:function(a,b,g,f){this.data("selectCallback",b);var c=this.attr("id");Drupal.settings.nameAutocomplete[c]={responseDataProcessor:f,data:{}};this.autocomplete({minLength:a,source:function(a,b){d.isNumeric(a.term)||(Drupal.settings.nameAutocomplete[c].response=b,tUtils.ajax(g(a),!1,!1,!1,{data:{id:c}}))},select:function(a,d){b(Drupal.settings.nameAutocomplete[c].data[d.item.label]);a.preventDefault()}});var e=this.outerWidth(),h=this.autocomplete("widget");this.on("autocompleteopen",
function(a,b){h.css("width","");h.css("min-width",e);h.css("max-width",2*e)})},selectFirstDropdownItem:function(){var a=Drupal.settings.nameAutocomplete[d(this).attr("id")].data;if(0!==a.length){var b=Object.keys(a);0!==b.length&&(a=a[b[0]],this.data("selectCallback")(a))}}};return b[a]?b[a].apply(this,Array.prototype.slice.call(arguments,1)):b.init.apply(this,arguments)};d.fn.addClearTextBtn=function(a,b){var c=this,e=d("<div>");e.addClass(b||"search-reset");b=d('<a href="#"></a>');e.append(b);b.click(function(){c.val("");
c.keyup();"undefined"!==typeof a&&a();return!1});c.parent().append(e);b=(c.outerHeight()-e.outerHeight())/2;e.css("bottom",b)}})(jQuery);
;
(function ($) {
  ...
  MobileConverter = (function () {
     ...
     */
    const tabletWidthBreakpoint = 990;
     ...
     */
    const toMobileTransforms = [];
    const fromMobileTransforms = [];
    const toTabletTransforms = [];
    const fromTabletTransforms = [];
    ...
    function checkMobileAndCovnert () {
      ...
      const newState = _getWindowState();
      if (newState === state) {
        return;
      }
    ...
    return {
      ...
      forceDesktopVersion: function () {
        const metas = document.getElementsByName("viewport");
        if (metas.length > 0) {
...
;
Drupal.locale = { 'pluralFormula': function ($n) { return Number((((($n%10)==1)&&(($n%100)!=11))?(0):((((($n%10)>=2)&&(($n%10)<=4))&&((($n%100)<10)||(($n%100)>=20)))?(1):2))); }, 'strings': {"":{"An AJAX HTTP error occurred.":"\u0412\u043e\u0437\u043d\u0438\u043a\u043b\u0430 AJAX HTTP \u043e\u0448\u0438\u0431\u043a\u0430.","HTTP Result Code: !status":"\u041f\u043e\u043b\u0443\u0447\u0435\u043d\u043d\u044b\u0439 \u043a\u043e\u0434 HTTP: !status","An AJAX HTTP request terminated abnormally.":"HTTP \u0437\u0430\u043f\u0440\u043e\u0441 AJAX \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043d \u043d\u0435\u043f\u0440\u0430\u0432\u0438\u043b\u044c\u043d\u043e.","Debugging information follows.":"\u0421\u043b\u0435\u0434\u0443\u0435\u0442 \u043e\u0442\u043b\u0430\u0434\u043e\u0447\u043d\u0430\u044f \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044f.","Path: !uri":"\u041f\u0443\u0442\u044c: !uri","StatusText: !statusText":"\u0422\u0435\u043a\u0441\u0442 \u0421\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f: !statusText","ResponseText: !responseText":"\u0422\u0435\u043a\u0441\u0442 \u041e\u0442\u0432\u0435\u0442\u0430: !responseText","ReadyState: !readyState":"ReadyState: !readyState","Loading":"\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430","(active tab)":"(\u0430\u043a\u0442\u0438\u0432\u043d\u0430\u044f \u0432\u043a\u043b\u0430\u0434\u043a\u0430)","All":"\u0412\u0441\u0435","Re-order rows by numerical weight instead of dragging.":"\u0423\u043f\u043e\u0440\u044f\u0434\u043e\u0447\u0438\u0442\u044c \u0441\u0442\u0440\u043e\u043a\u0438 \u043f\u043e \u0432\u0435\u0441\u0443 \u0432\u043c\u0435\u0441\u0442\u043e \u043f\u0435\u0440\u0435\u0442\u0430\u0441\u043a\u0438\u0432\u0430\u043d\u0438\u044f.","Show row weights":"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0432\u0435\u0441 \u0441\u0442\u0440\u043e\u043a","Hide row weights":"\u0421\u043a\u0440\u044b\u0442\u044c \u0432\u0435\u0441 \u0441\u0442\u0440\u043e\u043a","Drag to re-order":"\u0418\u0437\u043c\u0435\u043d\u0438\u0442\u044c \u043f\u043e\u0440\u044f\u0434\u043e\u043a \u043c\u043e\u0436\u043d\u043e, \u043f\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0432 \u043f\u0443\u043d\u043a\u0442 \u043c\u044b\u0448\u043a\u043e\u0439.","Changes made in this table will not be saved until the form is submitted.":"\u0421\u0434\u0435\u043b\u0430\u043d\u043d\u044b\u0435 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u043d\u0435 \u0432\u0441\u0442\u0443\u043f\u044f\u0442 \u0432 \u0441\u0438\u043b\u0443, \u043f\u043e\u043a\u0430 \u0432\u044b \u043d\u0435 \u0441\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u0435 \u0438\u0445.","Hide":"\u0421\u043a\u0440\u044b\u0442\u044c","Show":"\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c","Status":"\u0421\u0442\u0430\u0442\u0443\u0441","Edit":"\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c","Not published":"\u041d\u0435 \u043e\u043f\u0443\u0431\u043b\u0438\u043a\u043e\u0432\u0430\u043d\u043e","Size":"\u0420\u0430\u0437\u043c\u0435\u0440","This field is required.":"\u042d\u0442\u043e \u043f\u043e\u043b\u0435 \u043e\u0431\u044f\u0437\u0430\u0442\u0435\u043b\u044c\u043d\u043e \u0434\u043b\u044f \u0437\u0430\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u044f.","Configure":"\u041d\u0430\u0441\u0442\u0440\u043e\u0438\u0442\u044c","Wed":"\u0441\u0440","@title dialog":"\u0414\u0438\u0430\u043b\u043e\u0433 @title","Next":"\u0412\u043f\u0435\u0440\u0435\u0434","Sunday":"\u0432\u043e\u0441\u043a\u0440\u0435\u0441\u0435\u043d\u044c\u0435","Monday":"\u043f\u043e\u043d\u0435\u0434\u0435\u043b\u044c\u043d\u0438\u043a","Tuesday":"\u0432\u0442\u043e\u0440\u043d\u0438\u043a","Wednesday":"\u0441\u0440\u0435\u0434\u0430","Thursday":"\u0447\u0435\u0442\u0432\u0435\u0440\u0433","Friday":"\u043f\u044f\u0442\u043d\u0438\u0446\u0430","Saturday":"\u0441\u0443\u0431\u0431\u043e\u0442\u0430","Add":"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c","Filename":"\u0418\u043c\u044f \u0444\u0430\u0439\u043b\u0430","Upload":"\u0417\u0430\u043a\u0430\u0447\u0430\u0442\u044c","Done":"\u0413\u043e\u0442\u043e\u0432\u043e","N\/A":"\u043d\u0435\u0442","Prev":"\u041d\u0430\u0437\u0430\u0434","Mon":"\u043f\u043d","Tue":"\u0432\u0442","Thu":"\u0447\u0442","Fri":"\u043f\u0442","Sat":"\u0441\u0431","Sun":"\u0432\u0441","January":"\u042f\u043d\u0432\u0430\u0440\u044c","February":"\u0424\u0435\u0432\u0440\u0430\u043b\u044c","March":"\u043c\u0430\u0440\u0442\u0430","April":"\u0430\u043f\u0440\u0435\u043b\u044f","May":"\u043c\u0430\u044f","June":"\u0438\u044e\u043d\u044f","July":"\u0418\u044e\u043b\u044c","August":"\u0430\u0432\u0433\u0443\u0441\u0442\u0430","September":"\u0441\u0435\u043d\u0442\u044f\u0431\u0440\u044f","October":"\u043e\u043a\u0442\u044f\u0431\u0440\u044f","November":"\u043d\u043e\u044f\u0431\u0440\u044f","December":"\u0434\u0435\u043a\u0430\u0431\u0440\u044f","Select all rows in this table":"\u041e\u0442\u043c\u0435\u0442\u0438\u0442\u044c \u0432\u0441\u0435 \u0441\u0442\u0440\u043e\u043a\u0438 \u0442\u0430\u0431\u043b\u0438\u0446\u044b","Deselect all rows in this table":"\u0421\u043d\u044f\u0442\u044c \u043e\u0442\u043c\u0435\u0442\u043a\u0443 \u0441\u043e \u0432\u0441\u0435\u0445 \u043a\u043e\u043b\u043e\u043d\u043e\u043a \u0442\u0430\u0431\u043b\u0438\u0446\u044b","Today":"\u0421\u0435\u0433\u043e\u0434\u043d\u044f","Jan":"\u042f\u043d\u0432","Feb":"\u0424\u0435\u0432","Mar":"\u041c\u0430\u0440","Apr":"\u0410\u043f\u0440","Jun":"\u0418\u044e\u043d","Jul":"\u0418\u044e\u043b","Aug":"\u0410\u0432\u0433","Sep":"\u0421\u0435\u043d","Oct":"\u041e\u043a\u0442","Nov":"\u041d\u043e\u044f","Dec":"\u0414\u0435\u043a","Su":"\u0412\u0441","Mo":"\u041f\u043d","Tu":"\u0412\u0442","We":"\u0421\u0440","Th":"\u0427\u0442","Fr":"\u041f\u0442","Sa":"\u0421\u0431","mm\/dd\/yy":"mm\/dd\/yy","Only files with the following extensions are allowed: %files-allowed.":"\u041f\u0440\u0438\u043a\u0440\u0435\u043f\u043b\u044f\u0442\u044c \u043c\u043e\u0436\u043d\u043e \u0442\u043e\u043b\u044c\u043a\u043e \u0444\u0430\u0439\u043b\u044b \u0441 \u0440\u0430\u0441\u0448\u0438\u0440\u0435\u043d\u0438\u044f\u043c\u0438: %files-allowed.","By @name on @date":"@name, @date","By @name":"@name","Not in menu":"\u041d\u0435 \u0432 \u043c\u0435\u043d\u044e","Alias: @alias":"\u0421\u0438\u043d\u043e\u043d\u0438\u043c: @alias","No alias":"\u0421\u0438\u043d\u043e\u043d\u0438\u043c \u043d\u0435 \u0437\u0430\u0434\u0430\u043d","New revision":"\u041d\u043e\u0432\u0430\u044f \u0440\u0435\u0434\u0430\u043a\u0446\u0438\u044f","The changes to these blocks will not be saved until the \u003Cem\u003ESave blocks\u003C\/em\u003E button is clicked.":"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f, \u0441\u0434\u0435\u043b\u0430\u043d\u043d\u044b\u0435 \u0432 \u0431\u043b\u043e\u043a\u0430\u0445 \u043d\u0435 \u0432\u0441\u0442\u0443\u043f\u044f\u0442 \u0432 \u0441\u0438\u043b\u0443 \u043f\u043e\u043a\u0430 \u0432\u044b \u043d\u0435 \u043d\u0430\u0436\u043c\u0435\u0442\u0435 \u043a\u043d\u043e\u043f\u043a\u0443 \u003Cem\u003E\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0431\u043b\u043e\u043a\u0438\u003C\/em\u003E.","This permission is inherited from the authenticated user role.":"\u042d\u0442\u043e \u043f\u0440\u0430\u0432\u043e \u043d\u0430\u0441\u043b\u0435\u0434\u0443\u0435\u0442\u0441\u044f \u043e\u0442 \u0440\u043e\u043b\u0438 \u00ab\u0417\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u044b\u0439 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044c\u00bb.","No revision":"\u041d\u0435\u0442 \u0440\u0435\u0434\u0430\u043a\u0446\u0438\u0438","Requires a title":"\u0422\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044f \u0437\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a","Not restricted":"\u0411\u0435\u0437 \u043e\u0433\u0440\u0430\u043d\u0438\u0447\u0435\u043d\u0438\u0439","Not customizable":"\u041d\u0435 \u043d\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u043c\u044b\u0439","Restricted to certain pages":"\u041e\u0433\u0440\u0430\u043d\u0438\u0447\u0435\u043d\u043e \u0434\u043b\u044f \u043e\u043f\u0440\u0435\u0434\u0435\u043b\u0451\u043d\u043d\u044b\u0445 \u0441\u0442\u0440\u0430\u043d\u0438\u0446","The block cannot be placed in this region.":"\u0411\u043b\u043e\u043a \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0440\u0430\u0437\u043c\u0435\u0449\u0451\u043d \u0432 \u044d\u0442\u043e\u043c \u0440\u0435\u0433\u0438\u043e\u043d\u0435.","Hide summary":"\u0421\u043a\u0440\u044b\u0442\u044c \u0430\u043d\u043e\u043d\u0441","Edit summary":"\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0430\u043d\u043e\u043d\u0441","Don\u0027t display post information":"\u041d\u0435 \u043f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0442\u044c \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044e \u043c\u0430\u0442\u0435\u0440\u0438\u0430\u043b\u0430","The selected file %filename cannot be uploaded. Only files with the following extensions are allowed: %extensions.":"\u0412\u044b\u0431\u0440\u0430\u043d\u043d\u044b\u0439 \u0444\u0430\u0439\u043b %filename \u043d\u0435 \u043c\u043e\u0436\u0435\u0442 \u0431\u044b\u0442\u044c \u0437\u0430\u0433\u0440\u0443\u0436\u0435\u043d. \u0412\u043e\u0437\u043c\u043e\u0436\u043d\u043e \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u0444\u0430\u0439\u043b\u043e\u0432 \u0442\u043e\u043b\u044c\u043a\u043e \u0441\u043e \u0441\u043b\u0435\u0434\u0443\u044e\u0449\u0438\u043c\u0438 \u0440\u0430\u0441\u0448\u0438\u0440\u0435\u043d\u0438\u044f\u043c\u0438: %extensions.","Autocomplete popup":"\u0412\u0441\u043f\u043b\u044b\u0432\u0430\u044e\u0449\u0435\u0435 \u0430\u0432\u0442\u043e\u0437\u0430\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u0435","Searching for matches...":"\u041f\u043e\u0438\u0441\u043a \u0441\u043e\u0432\u043f\u0430\u0434\u0435\u043d\u0438\u0439..."}} };;
(function ($) {
...
(function ($) {
  ...
  function partnerRequestsTableConvert(context) {
    ...
    $(".requests-table tbody tr", context).each(function () {
      const $row = $(this);
      const $allBtnsCell = $("<td class='all-btns-cell'></td>");
  ...
  function expandPricelistServicesGroups() {
    const $toggler =  $("#block-views-pricelist-services-groups-block h2");
    const $groupList = $(".view-pricelist-services-groups");
